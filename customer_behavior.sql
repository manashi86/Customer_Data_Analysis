...
--which are the top 5 product with avg review rating?
...
--between subscriber and non subcriber customer
...
--Are customer who are repeat buyers (more than 5 previous purchases)are likely to subscribe?
select subscription_status,
...
--What is the revenue contribution each age group?
select age_group,
